...
d["initialized"] = nbt_tag.Byte(1)
d["Time"] = nbt_tag.Long(0)
d["DayTime"] = nbt_tag.Long(0)
d["LastPlayed"] = nbt_tag.Long(0)
d["SizeOnDisk"] = nbt_tag.Long(0)
# Minimal Player compound (required for single player save list)
pl = nbt_tag.Compound()
...
d["generatorOptions"] = nbt_tag.String("3;minecraft:air;64;minecraft:the_void")
